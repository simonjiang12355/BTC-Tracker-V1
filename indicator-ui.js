(function () {
  const axes = {
    nupl: {
      ...
      max: 1,
      segments: [
        { from: -0.25, to: 0, label: "Bear bottom", comment: "Bear market bottom zone", color: "#ff4f2e" },
        { from: 0, to: 0.25, label: "Early bull", comment: "Early bull / late bear", color: "#ff7a1a" },
        { from: 0.25, to: 0.5, label: "Confidence", comment: "Market gaining confidence", color: "#39ff5a" },
        { from: 0.5, to: 0.75, label: "Strong bull", comment: "Strong bull, approaching greed", color: "#22e84e" },
        { from: 0.75, to: 1, label: "Top risk", comment: "Historically aligns with tops", color: "#ff7a1a" },
      ],
    },
    puell: {
      min: 0,
      max: 4,
      segments: [
        { from: 0, to: 0.5, label: "Oversold", comment: "Oversold, possible market bottom", color: "#39ff5a" },
        { from: 0.5, to: 2, label: "Neutral", comment: "Neutral, bull cycle in progress, not extreme", color: "#ff7a1a" },
        { from: 2, to: 3.5, label: "Overbought", comment: "Overbought, likely cycle peak", color: "#ff4f2e" },
        { from: 3.5, to: 4, label: "Peak risk", comment: "Overbought, likely cycle peak, especially elevated", color: "#ff7a1a" },
      ],
    },
    mvrv: {
      min: 0,
      max: 4.5,
      segments: [
        { from: 0, to: 1, label: "Undervalued", comment: "BTC trading below cost basis, bottom undervalued zone", color: "#39ff5a" },
        { from: 1, to: 2, label: "Fair", comment: "Fair value or accumulation zone, neutral / early bull", color: "#22e84e" },
        { from: 2, to: 2.5, label: "Elevated", comment: "Between fair value and elevated risk zone", color: "#ff7a1a" },
        { from: 2.5, to: 3.5, label: "Correction risk", comment: "Aggressive profit-taking zone, growing risk of correction", color: "#ff4f2e" },
        { from: 3.5, to: 4.5, label: "Cycle top risk", comment: "Euphoria, mass profit, unsustainable, cycle top likely", color: "#ff7a1a" },
      ],
    },
  };
